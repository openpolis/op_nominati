...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipologiaEnte'
        db.create_table(u'tipologia_ente', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('denominazione', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('nominati', ['TipologiaEnte'])

        # Adding field 'Ente.tipologia_ente'
        db.add_column(u'ente', 'tipologia_ente',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['nominati.TipologiaEnte'], db_column='tipologia_ente'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TipologiaEnte'
        db.delete_table(u'tipologia_ente')

        # Deleting field 'Ente.tipologia_ente'
        db.delete_column(u'ente', 'tipologia_ente')
