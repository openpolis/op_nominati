...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incarico.altri_compensi'
        db.alter_column(u'incarico', 'altri_compensi', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Incarico.compenso_anno'
        db.alter_column(u'incarico', 'compenso_anno', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Incarico.compenso_carica'
        db.alter_column(u'incarico', 'compenso_carica', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Incarico.indennita_risultato'
        db.alter_column(u'incarico', 'indennita_risultato', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Incarico.altri_compensi'
        db.alter_column(u'incarico', 'altri_compensi', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Incarico.compenso_anno'
        db.alter_column(u'incarico', 'compenso_anno', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Incarico.compenso_carica'
        db.alter_column(u'incarico', 'compenso_carica', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Incarico.indennita_risultato'
        db.alter_column(u'incarico', 'indennita_risultato', self.gf('django.db.models.fields.FloatField')(null=True))
