...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bilancio'
        db.create_table('nominati_bilancio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('anno', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('resoconto', self.gf('django.db.models.fields.IntegerField')()),
            ('dettaglio', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('ente_cf', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nominati.Ente'], db_column='ente_cf')),
        ))
        db.send_create_signal('nominati', ['Bilancio'])


    def backwards(self, orm):
        # Deleting model 'Bilancio'
        db.delete_table('nominati_bilancio')
