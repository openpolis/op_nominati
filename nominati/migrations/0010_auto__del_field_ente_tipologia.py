...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ente.tipologia'
        db.delete_column(u'ente', 'tipologia')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ente.tipologia'
        raise RuntimeError("Cannot reverse this migration. 'Ente.tipologia' and its values cannot be restored.")
