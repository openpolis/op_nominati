...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IstituzioneHasEnte.dichiarazione_inviata'
        db.alter_column(u'istituzione_has_ente', 'dichiarazione_inviata', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'IstituzioneHasEnte.dichiarazione_inviata'
        db.alter_column(u'istituzione_has_ente', 'dichiarazione_inviata', self.gf('django.db.models.fields.CharField')(max_length=255))
