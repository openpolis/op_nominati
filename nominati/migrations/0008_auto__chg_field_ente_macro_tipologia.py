...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ente.macro_tipologia'
        db.alter_column(u'ente', 'macro_tipologia', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Ente.macro_tipologia'
        db.alter_column(u'ente', 'macro_tipologia', self.gf('django.db.models.fields.CharField')(max_length=255))
