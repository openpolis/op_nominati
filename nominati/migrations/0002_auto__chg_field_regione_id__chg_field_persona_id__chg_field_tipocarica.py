...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Regione.id'
        db.alter_column(u'regione', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Persona.id'
        db.alter_column(u'persona', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'TipoCarica.id'
        db.alter_column(u'tipo_carica', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Regione.id'
        db.alter_column(u'regione', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Persona.id'
        db.alter_column(u'persona', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'TipoCarica.id'
        db.alter_column(u'tipo_carica', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
